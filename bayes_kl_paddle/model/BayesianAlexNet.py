...
class BBBAlexNet(ModuleWrapper):
    ...
    def __init__(self, input_dim, num_classes, priors, layer_type='lrt', activation_type='softplus'):
        ...
        self.conv1 = BBBConv2d(input_dim, 64, 11, stride=4, padding=5, bias=True, priors=self.priors)
        self.act1 = self.act()
        ...
        self.classifier = BBBLinear(1 * 1 * 128, num_classes, bias=True, priors=self.priors)
